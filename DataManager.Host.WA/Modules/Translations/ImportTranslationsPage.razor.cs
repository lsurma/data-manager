...
namespace DataManager.Host.WA.Modules.Translations
{
    public partial class ImportTranslationsPage : ComponentBase, IDisposable
    {
        ...
        private List<TranslationsSetDto> AvailableTranslationsSets => AppContext.TranslationsSets;
        private Guid? SelectedTranslationsSetId;
        private TranslationsSetDto? SelectedDataSet;
        private string? SelectedDataSetValue
        {
            get => SelectedTranslationsSetId?.ToString();
            set
            {
                if (Guid.TryParse(value, out var id))
                {
                    SelectedTranslationsSetId = id;
                }
        ...
        protected override void OnInitialized()
        {
            ...
            if (AvailableTranslationsSets.Any())
            {
                SelectedTranslationsSetId = AvailableTranslationsSets.FirstOrDefault()?.Id;
            }
        ...
        private void HandleContextRefreshed()
        {
            ...
            if (SelectedTranslationsSetId != null && !AvailableTranslationsSets.Any(ds => ds.Id == SelectedTranslationsSetId))
            {
                SelectedTranslationsSetId = AvailableTranslationsSets.FirstOrDefault()?.Id;
            }
        ...
        private async Task StartImportAsync()
        {
            ...
            if (ImportedTranslations == null || !ImportedTranslations.Any() || !SelectedTranslationsSetId.HasValue)
            {
            ...
            try
            {
                ...
                {
                    TranslationsSetId = SelectedTranslationsSetId.Value,
