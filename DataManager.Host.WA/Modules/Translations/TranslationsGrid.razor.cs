...
public partial class TranslationsGrid : ComponentBase, IDisposable
{
    ...
    private List<TranslationsSetDto> AllDataSets => AppContext.TranslationsSets;
    ...
    {
        var dataSetIdChanged = parameters.TryGetValue<Guid?>(nameof(TranslationsSetId), out var newDataSetId) && newDataSetId != TranslationsSetId;
        if (dataSetIdChanged)
        {
            TranslationsSetId = newDataSetId;
    ...
    private List<IQueryFilter> BuildQueryFilters()
    {
        ...
        {
            filters.Add(new TranslationsSetIdFilter { Value = TranslationsSetId.Value });
        }
    ...
    private async Task OpenTranslationPanelAsync(TranslationDto? translation = null)
    {
        ...
        var parameters = new TranslationPanelParameters
        {
            ...
            TranslationsSetId = TranslationsSetId,
            OnDataChanged = async () =>
            {
                RefreshToken = Guid.NewGuid().ToString();
                LoadLayoutsAsync();
        ...
        {
            NavigationManager.NavigateTo(TranslationsSetId != null ? "/translations/" + TranslationsSetId : "/translations", false);
        }
