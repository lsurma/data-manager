...
public interface IAuthorizationService
{
    ...
    /// </summary>
    /// <param name="translationSetId">The ID of the TranslationSet to check access for</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>True if user has access, false otherwise</returns>
    Task<bool> CanAccessDataSetAsync(Guid translationSetId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<(bool AllAccessible, List<Guid> AccessibleIds)> GetAccessibleTranslationSetIdsAsync(CancellationToken cancellationToken = default);
}
