...
public class TranslationConfiguration : AuditableEntityConfiguration<Translation>
{
    protected override void ConfigureEntity(EntityTypeBuilder<Translation> builder)
    {
        ...
        // Configure relationship with TranslationsSet
        builder.HasOne(e => e.TranslationsSet)
            .WithMany()
            .HasForeignKey(e => e.TranslationsSetId)
        ...
        builder.HasIndex(e => e.TranslationsSetId);
