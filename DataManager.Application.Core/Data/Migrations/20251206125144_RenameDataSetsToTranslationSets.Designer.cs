...
namespace DataManager.Application.Core.Data.Migrations
{
    ...
    [Migration("20251206125144_RenameDataSetsToTranslationSets")]
    partial class RenameDataSetsToTranslationSets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataManager.Application.Core.Modules.TranslationSet.TranslationSetInclude", b =>
                {
                    b.HasOne("DataManager.Application.Core.Modules.TranslationSet.TranslationSet", "IncludedTranslationSet")
                        .WithMany("IncludedIn")
                        .HasForeignKey("IncludedTranslationSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataManager.Application.Core.Modules.TranslationSet.TranslationSet", "ParentTranslationSet")
                        .WithMany("Includes")
