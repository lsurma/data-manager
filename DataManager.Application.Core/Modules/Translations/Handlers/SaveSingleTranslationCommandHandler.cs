...
public class SaveSingleTranslationCommandHandler : IRequestHandler<SaveSingleTranslationCommand, Guid>
{
    ...
    public SaveSingleTranslationCommandHandler(DataManagerDbContext context, TranslationsQueryService queryService)
    {
        _context = context;
    ...
    public async Task<Guid> Handle(SaveSingleTranslationCommand request, CancellationToken cancellationToken)
    {
        ...
        if (request.Id.HasValue && request.Id.Value != Guid.Empty)
        {
            ...
            bool hasChanges = translation.InternalGroupName1 != request.InternalGroupName1
                ...
                || translation.TranslationsSetId != request.TranslationsSetId
            ...
            if (shouldCreateOldVersion)
            {
                ...
                var oldVersion = new Translation
                {
                    ...
                    TranslationsSetId = translation.TranslationsSetId,
